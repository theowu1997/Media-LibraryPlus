      ...
      <div className="settings-grid">
        ...
        <div className="panel">
          ...
          <p className="subtle">
            ...
            then tries online poster lookup by detected video ID. Add a TMDB v4
            read access token only if you also want title-based fallback for files
            that do not have a usable video ID. Existing titles can be backfilled by
        ...
        <div className="panel">
          ...
          <ul className="plain-list">
            ...
            <li>Starter PIN: {appState.starterPinHint}</li>
          </ul>
        </div>
        ...
        <div className="panel">
          <p className="eyebrow">Subtitle Directories</p>
          <p className="subtle" style={{ marginBottom: "0.75rem" }}>
            Add folders that contain .srt / .ass / .vtt files. "Subtitle Scan" will match them
          ...
          <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap", alignItems: "center" }}>
            ...
            >
              {subtitleScanRunning ? "Scanning…" : "🔍 Subtitle Scan"}
            </button>
          </div>
          {subtitleScanResult && (
